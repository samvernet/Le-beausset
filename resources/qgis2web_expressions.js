...
function exp_label_Typedenseigne_1_eval_expression(context) {
    // Etablissem

    var feature = context.feature;
    
    if (feature.properties) {
        return feature.get('Etablissem') ;
    } else {
        return feature.get('Etablissem') ;
    }
}
...
function exp_label_Notesdevanture_2_eval_expression(context) {
    // Etablissem
...
function exp_Emplacementn12_4rule0_eval_expression(context) {
    // Emp = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Emp')  == 1);
    } else {
        return (feature.get('Emp')  == 1);
    }
}
...
function exp_Emplacementn12_4rule1_eval_expression(context) {
    // Emp = 2

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Emp')  == 2);
    } else {
        return (feature.get('Emp')  == 2);
    }
}